...
def print_results(results_dic, results_stats_dic, model, 
    ...
    # Print misclassified dogs if requested and they exist
    ...
    # Print misclassified breeds if requested and they exist
    if print_incorrect_breed and (results_stats_dic['n_correct_dogs'] != results_stats_dic['n_correct_breed']):
        print("\nINCORRECT Breed Classifications:")
        for key in results_dic:
            if sum(results_dic[key][3:]) == 2 and results_dic[key][2] == 0:
                print(f"Pet Image: {key}, Pet Label: {results_dic[key][0]}, Classifier Label: {results_dic[key][1]}")
